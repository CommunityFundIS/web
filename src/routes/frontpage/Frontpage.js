      ...
      <div className={s.container}>
          ...
          <div className={cx(s.wrapper, s.firstWrapper)}>
            ...
            <div style={{ zIndex: 10 }}>
              ...
              <div className={s.slogan}>
                We support the Icelandic tech community by easing the access to
                capital for events.
              </div>
            </div>
            <Link
        ...
        <div className={s.secondContainer}>
          <div className={cx(s.wrapper, s.secondWrapper)}>
            <div>
              <p>
                The Community Fund helps community builders plan events around
                their passion.
              </p>
              <p>
                We
                {"'"}
                re here to enable the tech and startup community grow closer and
                better, by making events, meetups, and other initiatives easier
                to execute.
              </p>
              <p>
                Our partners provide funding, experience, and connections to
