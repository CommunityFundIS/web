      ...
      <div className={s.container}>
        ...
        <div className={s.content}>
          <div className={s.person}>
            <img src="/img/team/hjalli.jpg" alt="Kristinn Árni Lár Hróbjartsson" />
            <h2>Hjálmar Gíslason</h2>
            <h2>Investa</h2>
          </div>
          <div className={s.person}>
            <img src="/img/team/kristjanmik.jpg" alt="Kristján Ingi Mikaelsson" />
        ...
        <div className={s.content}>
          <div className={s.person}>
            <img src="/img/team/kiddi_kassi.png" alt="Kristinn Árni Lár Hróbjartsson" />
